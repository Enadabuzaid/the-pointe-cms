...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?>  <?php echo e($menuinfo->name); ?> <?php $__env->endSlot(); ?>
    ...
    <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" data-bs-scroll="true">
        <div class="modal-dialog">
            ...
            <form action="<?php echo e(route('menuitem.store')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <?php echo method_field('POST'); ?>
                <input  name="menu_id" type="hidden"  value="<?php echo e($menuinfo->id); ?>" >
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" data-trigger name="parent_id"  id="choices-single-default"    >
                            ...
                            <?php $__currentLoopData = $menuitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($menuitem->id); ?> "><?php echo e($menuitem->title); ?> </option>
                ...
                <div class="card-body">
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tr>
                            ...
                            <td>
                                <a title="delete" type="button" class="text-danger" data-bs-toggle="modal" data-bs-target="#exampleModal_<?php echo e($menuitem->id); ?>" data-bs-whatever="@mdo">
                                    <i data-feather="trash-2"></i>
                                </a>

                                <a title="switch status" type="button" class="text-secondary" data-bs-toggle="modal" data-bs-target="#switch<?php echo e($menuitem->id); ?>" data-bs-whatever="@mdo">
                                    <i data-feather="refresh-ccw"></i>
                                </a>

                                <a title="Edit" type="button" class="text-primary" data-bs-toggle="modal" data-bs-target="#edit<?php echo e($menuitem->id); ?>" data-bs-whatever="@mdo">
                        ...
                        <div class="modal fade" id="exampleModal_<?php echo e($menuitem->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="<?php echo e(route('menuitem.destroy')); ?>" method="post" id="delteForm">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <div class="mb-3">
                                                <input type="hidden" class="form-control" name="id" value="<?php echo e($menuitem->id); ?>" id="recipient-name">
                                            </div>
                                        </form>
                                    </div>
                                    <div class="modal-footer">
                        ...
                        <div class="modal fade" id="switch<?php echo e($menuitem->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <form action="<?php echo e(route('menuitem.switch')); ?>" method="post" id="swichForm">
                                            <?php echo csrf_field(); ?>
                        ...
                        <div class="modal fade" id="edit<?php echo e($menuitem->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <form action="<?php echo e(route('menuitem.update')); ?>" method="post" id="editForm">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <input type="hidden" class="form-control" name="id" value="<?php echo e($menuitem->id); ?>" id="recipient-name">
                                    <input  name="menu_id" type="hidden"  value="<?php echo e($menuinfo->id); ?>" >
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">Title</label>
                                                <input class="form-control" value="<?php echo e($menuitem->title); ?>" name="title" type="text" placeholder="menuitem title" id="example-text-input">
                                            </div>
                        
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">URL</label>
                                                <input class="form-control" value="<?php echo e($menuitem->url); ?>" name="url" type="url" placeholder="menuitem URL" id="example-text-input">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control" data-trigger name="parent_id"  id="choices-single-default"    >
                                                    <option value="0">root</option>
                                                    <?php $__currentLoopData = $menuitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuitem_select): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                      <option  <?php if($menuitem->parent_id == $menuitem_select->id): ?> selected <?php endif; ?> value="<?php echo e($menuitem_select->id); ?> "><?php echo e($menuitem_select->title); ?> </option>
                                                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                                 </select>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">Order</label>
                                                <input class="form-control" value="<?php echo e($menuitem->order); ?>"  name="order" type="number" placeholder="menuitem Order" id="example-text-input">
                                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/admin/menu/itemlist.blade.php ENDPATH**/ ?>