            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li><li><a href="<?php echo e(route('menu')); ?>" data-key="t-menu">main menu</a></li></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li><li><a href="<?php echo e(route('redirect')); ?>" data-key="t-menu">redirect list </a></li></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">-
                        <li><li><a href="<?php echo e(route('sitemap.index')); ?>" data-key="t-menu">sitemap</a></li></li>
                    </ul>
                </li>
