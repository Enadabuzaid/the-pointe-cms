        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-none d-sm-inline-block">
                ...
                <?php switch(Session::get('lang')):
                    case ('ar'): ?>
                       <img src="<?php echo e(URL::asset('/assets/images/flags/ar.png')); ?>" alt="Header Language" height="16">
                    <?php break; ?>
                    <?php default: ?>
                        <img src="<?php echo e(URL::asset('/assets/images/flags/us.png')); ?>" alt="Header Language" height="16">
                <?php endswitch; ?>
            </button>
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a href="<?php echo e(url('index/en')); ?>" class="dropdown-item notify-item language" data-lang="eng">
                    <img src="<?php echo e(URL::asset ('/assets/images/flags/us.png')); ?>" alt="user-image" class="me-1" height="12"> <span class="align-middle"><?php echo app('translator')->get('translation.english'); ?></span>
                </a>
                <!-- item-->

                <!-- item-->
                <a href="<?php echo e(url('index/ar')); ?>" class="dropdown-item notify-item language" data-lang="eng">
                    <img src="<?php echo e(URL::asset ('/assets/images/flags/ar.png')); ?>" alt="user-image" class="me-1" height="12"> <span class="align-middle"><?php echo app('translator')->get('translation.arabic'); ?></span>
                </a>
                <!-- item-->
