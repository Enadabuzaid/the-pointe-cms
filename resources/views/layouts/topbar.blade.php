        ...
        <div class="d-flex">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a href="{{ url('index/en') }}" class="dropdown-item notify-item language" data-lang="eng">
                    <img src="{{ URL::asset ('/assets/images/flags/us.png') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">@lang('translation.english')</span>
                </a>
                <!-- item-->

                <!-- item-->
                <a href="{{ url('index/ar') }}" class="dropdown-item notify-item language" data-lang="eng">
                    <img src="{{ URL::asset ('/assets/images/flags/ar.png') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">@lang('translation.arabic')</span>
                </a>
                <!-- item-->
