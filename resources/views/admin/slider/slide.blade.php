...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title')  {{$sliderinfo->title}} @endslot
    ...
    <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" data-bs-scroll="true">
        <div class="modal-dialog">
            ...
            <form action="{{route('slide.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <input  name="slider_id" type="hidden"  value="{{$sliderinfo->id}}" >
                ...
                <div class="card-body">
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tr>
                            ...
                            <td>{{$slide->title}}</td>
                            <td>{{$slide->url}}</td>
                            <td><image width="100" src="{{ asset('images/slider/'.$slide->image_dt) }}"/></td>
                            <td><image width="100"  src="{{ asset('images/slider/'.$slide->image_mb) }}"/></td>
                                    <td>
                                @if($slide->status)
                            ...
                            <td>
                                <a title="delete" type="button" class="text-danger" data-bs-toggle="modal" data-bs-target="#exampleModal_{{$slide->id}}" data-bs-whatever="@mdo">
                                    <i data-feather="trash-2"></i>
                                </a>

                                <a title="switch status" type="button" class="text-secondary" data-bs-toggle="modal" data-bs-target="#switch{{$slide->id}}" data-bs-whatever="@mdo">
                                    <i data-feather="refresh-ccw"></i>
                                </a>

                                <a title="Edit" type="button" class="text-primary" data-bs-toggle="modal" data-bs-target="#edit{{$slide->id}}" data-bs-whatever="@mdo">
                        ...
                        <div class="modal fade" id="exampleModal_{{$slide->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{route('slide.destroy')}}" method="post" id="delteForm">
                                            @csrf
                                            @method('DELETE')
                                            <div class="mb-3">
                                                <input type="hidden" class="form-control" name="id" value="{{$slide->id}}" id="recipient-name">
                                            </div>
                                        </form>
                                    </div>
                                    <div class="modal-footer">
                        ...
                        <div class="modal fade" id="switch{{$slide->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        @endif
                                            ...
                                            <form action="{{route('slide.switch')}}" method="post" id="swichForm">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-3">
                                                <input type="hidden" class="form-control" name="id" value="{{$slide->id}}" id="recipient-name">
                        ...
                        <div class="modal fade" id="edit{{$slide->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <form action="{{route('slide.update')}}" method="post" id="editForm" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <input type="hidden" class="form-control" name="id" value="{{$slide->id}}" id="recipient-name">
                                    <input  name="slider_id"    type="hidden"  value="{{$sliderinfo->id}}" >
                                    <input  name="image_dt_old" type="hidden"  value="{{$slide->image_dt}}">
                                    <input  name="image_mb_old" type="hidden"  value="({{$slide->image_mb}}">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">Title</label>
                                                <input class="form-control" value="{{$slide->title}}" name="title" type="text" placeholder="slide title" id="example-text-input">
                                            </div>
                        
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">Description</label>
                                                <input class="form-control" value="{{$slide->description}}"  name="description" type="text" placeholder="description" id="example-text-input">
                                            </div>
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">Desktop image  </label>
                                                <input class="form-control"  name="image_dt" type="file" placeholder="Desktop image" >
                                            ...
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">URL</label>
                                                <input class="form-control" value="{{$slide->url}}" name="url" type="url" placeholder="slide URL" id="example-text-input">
                                            </div>


                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">slide active to</label>
                                                <input class="form-control"  value="{{$slide->active_date}}"  name="active_date" type="date" placeholder="slide active date" id="example-text-input">
                                            </div>
                        

                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">Order</label>
                                                <input class="form-control" value="{{$slide->order}}"  name="order" type="number" placeholder="slide Order" id="example-text-input">
                                            </div>
