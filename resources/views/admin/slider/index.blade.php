                ...
                <div class="card-body">
                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tr>
                            <td>{{$slider->id}}</td>
                            <td>{{$slider->title}}</td>
                            <td>{{$slider->css_class}}</td>
                            <td>{{$slider->html_id}}</td>
                             <td>
                                @if($slider->status)
                            ...
                            <td>
                                <a title="delete" type="button" class="text-danger" data-bs-toggle="modal" data-bs-target="#exampleModal_{{$slider->id}}" data-bs-whatever="@mdo">
                                    <i data-feather="trash-2"></i>
                                </a>

                                <a title="switch status" type="button" class="text-secondary" data-bs-toggle="modal" data-bs-target="#switch{{$slider->id}}" data-bs-whatever="@mdo">
                                    <i data-feather="refresh-ccw"></i>
                                </a>

                                <a title="Edit" type="button" class="text-primary" data-bs-toggle="modal" data-bs-target="#edit{{$slider->id}}" data-bs-whatever="@mdo">
                                    <i data-feather="edit"></i>
                                </a>
                                <a title="View" type="button" class="text-primary" href="slider/slides/{{$slider->id}}"  >
                                    <i data-feather="eye"></i>
                                </a>
                            </td>
                        </tr>

                        <div class="modal fade" id="exampleModal_{{$slider->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{route('slider.destroy')}}" method="post" id="delteForm">
                                            @csrf
                                            @method('DELETE')
                                            <div class="mb-3">
                                                <input type="hidden" class="form-control" name="id" value="{{$slider->id}}" id="recipient-name">
                                            </div>
                                        </form>
                                    </div>
                                    <div class="modal-footer">
                        ...
                        <div class="modal fade" id="switch{{$slider->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        @endif
                                            ...
                                            <form action="{{route('slider.switch')}}" method="post" id="swichForm">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-3">
                                                <input type="hidden" class="form-control" name="id" value="{{$slider->id}}" id="recipient-name">
                        ...
                        <div class="modal fade" id="edit{{$slider->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <form action="{{route('slider.update')}}" method="post" id="editForm">
                                    @csrf
                                    @method('PUT')
                                    <input type="hidden" class="form-control" name="id" value="{{$slider->id}}" id="recipient-name">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">Title</label>
                                                <input class="form-control"  value="{{$slider->title}}"  name="title" type="text" placeholder="slider Title" id="example-text-input">
                                            </div>
                        
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">Css Class</label>
                                                <input class="form-control" value="{{$slider->css_class}}"  name="css_class" type="text" placeholder="Css Class" id="example-text-input">
                                            </div>
                        
                                            <div class="mb-3">
                                                <label for="example-text-input" class="form-label">html Id</label>
                                                <input class="form-control" value="{{$slider->html_id}}"  name="html_id" type="text" placeholder="html id" id="example-text-input">
                                            </div>
