...
//    -----------
    ...
    "tenants"=>"المحلات",
    "tenantsCategory"=> "تصنيفات المحلات",
    "Deactivate"=>"غير مفعل",
    "Active"=>"مفعل",
    "empty_category_message"=>"لايوجد اي تصنيف للمحلات",
    "Go To"=>"اذهب الى",
    "Add Tenant Category"=>"اضف تصنيف للمحلات",
    "categoryname"=>"اسم التصنيف بالانجليزية",
    "categorydescription"=>"وصف التصنيف بالانجليزية",
    "categorynamear"=>" اسم التصنيف باللغة العربية",
    "categorydescriptionar"=>"وصف التصنيف باللغة العربية",
    "AddParentCategoryNote" => "سيتم اضافة تصنيف اساسي ..",
    "Delete Tenant Category" =>" حذف تصنيف المحل",
    "warningDelete"=> "هل انت متآكد من حذف هذا التصنيف",


    "addTenants" => "اضافة محل",
    "tenantsList" => "قائمة المحلات"
